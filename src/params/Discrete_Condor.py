...
class Params:
    ...
    results_path: str = 'results/post_laurea/discrete_multi_attractor/'
    ...
    goal_mapping_loss_weight: float = 0.05
    ...
    stabilization_window_size: int = 7  # 2 original  # stability window size
