...
class Params:
    ...
    results_path: str = 'results/shape/pokemon/adaptive-beta/bulbasaur/'
    ...
    shaped_attractors_form: str = "bulbasaur"  # if none, no shape is enforce to the attractors.
                                          # option: star
                                          #circle_interpolate,
                                          # circle  --> by file
    ...
    contrastive_norm_margin: float = 0.85
