...
class Params:
    ...
    results_path: str = 'results/shape/pokemon/bulbasaur/'    # log path
    ...
    shaped_attractors_form: str = "bulbasaur"                 # what shape load | option : None, start, squirtle, charmender, bulbasaur
    ...
    stabilization_loss_weight: float = 3.8          # stability loss weight
    ...
    contrastive_norm_margin: float = 0.85           # contrastive norm loss margin
