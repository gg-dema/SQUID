...
class Params:
    ...
    batch_size_contrastive_norm: int = 800
    batch_size_orientation_loss: int = 600
    ...
    cycle_orientation_loss_weight: float = 0.8

    boundary_loss_weight: float = 0.07
    ...
    contrastive_norm_margin: float = 0.50
    ...
    workspace_boundaries: str = np.array([[-1, 1],
                                          [-1, 1],
                                          [-1, 1],
