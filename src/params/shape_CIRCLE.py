...
class Params:
    ...
    results_path: str = 'results/shape/circle/'
    ...
    batch_size: int = 128  # 512  # sampling batch size
    batch_size_contrastive_norm: int = 128
    batch_size_orientation_loss: int = 128
    ...
    stabilization_loss_weight: float = 4.0
    ...
    contrastive_norm_margin: float = 1.
