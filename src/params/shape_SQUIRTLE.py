...
class Params:
    ...
    results_path: str = 'results/shape/pokemon/squirtle/'            # log path
    ...
    shaped_attractors_form: str = "star"                 # what shape load | option : None, start, squirtle, charmender, bulbasaur
    ...
    batch_size: int = 256                           # n point sampled in the imit and stability loss
    batch_size_contrastive_norm: int = 512          # n point sampled in the contrastive norm loss
    batch_size_orientation_loss: int = 512          # n point sampled in the orientation loss
    learning_rate: float = 0.00008                  # AdamW learning rate
    weight_decay: float = 0.000001                  # AdamW weight decay

    """ Contrastive Imitation """
    imitation_loss_weight: float = 0                # imitation loss weight
    stabilization_loss_weight: float = 5.0          # stability loss weight
    ...
    cycle_loss_weight: float = 0.8                  # weight of the Constrastive-Norm-Loss
    cycle_orientation_loss_weight: float = 2.5      # weight of the orientation loss
    ...
    contrastive_norm_margin: float = 0.9            # contrastive norm loss margin
