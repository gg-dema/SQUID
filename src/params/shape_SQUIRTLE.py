...
class Params:
    ...
    results_path: str = 'results/shape/pokemon/squirtle/'
    ...
    stabilization_loss_weight: float = 5.0
    goal_mapping_loss_weight: float = 0
    shaped_attractors_form: str = "squirtle"  # if none, no shape is enforce to the attractors.
                                          # option: star
                                          #circle_interpolate,
                                          # circle  --> by file
