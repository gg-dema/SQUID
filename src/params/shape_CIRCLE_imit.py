...
class Params:
    ...
    results_path: str = 'results/shape/circle-imit/'
    multi_motion: bool = False  # true when learning multiple motions together
    selected_primitives_ids: str = '15'  # id number from dataset_keys.py, e.g., '2' or '4,0,6'
    ...
    imitation_loss_weight: float = 2.8  # imitation loss weight
    stabilization_loss_weight: float = 7.0
    ...
    stabilization_window_size: int = 8  # 8 original  # stability window size
