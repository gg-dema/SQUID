...
class Params:
    ...
    results_path: str = 'results/shape/pokemon/charmender/'
    ...
    batch_size_orientation_loss: int = 512
    learning_rate: float = 0.00008  # used for star --> 0.00049  # AdamW learning rate
    weight_decay: float = 0.000001  # AdamW weight decay

    """ Contrastive Imitation """
    imitation_loss_weight: float = 0  # imitation loss weight
    stabilization_loss_weight: float = 3.8
    goal_mapping_loss_weight: float = 0
    shaped_attractors_form: str = "charmender"  # if none, no shape is enforce to the attractors.
                                          # option: star
                                          #circle_interpolate,
                                          # circle  --> by file
    ...
    cycle_loss_weight: float = 0.8
    cycle_orientation_loss_weight: float = 2.5

    boundary_loss_weight: float = 0.0  
    goal_mapping_decreasing_weight: float = 0.99
    imitation_window_size: int = 6  # 15 original  # imitation window size
    ...
    contrastive_norm_margin: float = 0.9
    # for star shape: contrastive margin for the norm = 1
    ...
    density: int = 19  # density^workspace_dimension = amount of points sampled from state space for evaluation
