...
class Params:
    ...
    results_path: str = 'results/manifold_meeting/s2-Bound/stab-'
    ...
    goal_mapping_loss_weight: float = 0.0           # weight of the goal mapping loss
    goal_mapping_decreasing_weight: float = 0.0     # decay rate of the goal mapping loss
    boundary_loss_weight: float = 0.004             # weight of the boundary loss
