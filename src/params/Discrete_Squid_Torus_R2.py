...
class Params:
    """ General parameters """
    dataset_name: str = 'multi_attractors'  # selects dataset, (multi-attractors, kuka, joint_space)
    results_path: str = 'results/torus/imit/'
    ...
    """ Multi Attractors """
    n_attractors: int = 2
    latent_dynamic_system_type: str = "torus"  # option: standard, gaussian, well_known_gaussian, well_known_multivariate, multivariate
    ...
    imitation_loss_weight: float = 3.0  # imitation loss weight
    stabilization_loss_weight: float = 0.7  # stability loss weight
    goal_mapping_loss_weight: float = 0.0
    goal_mapping_decreasing_weight: float = 0.994
    boundary_loss_weight: float = 0.0
    cycle_loss_weight: float = 0.0
    cycle_orientation_loss_weight: float = 0.0
    imitation_window_size: int = 12 # original  # imitation window size
    stabilization_window_size: int = 4  # 2 original  # stability window size
    stabilization_loss: str = 'contrastive'  # options: contrastive, triplet
    contrastive_margin: float = 3e-3  # contrastive loss margin
